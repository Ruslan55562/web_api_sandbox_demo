...
namespace sandbox_demo_Shared.Hooks
{
    public static class DBHook
    {
        ...
        public static void CleanupUsers(ScenarioContext scenarioContext)
        {
            try
            {
                if (!scenarioContext.ContainsKey("usernames"))
                    return;

                var usernames = scenarioContext["usernames"] as List<string>;
